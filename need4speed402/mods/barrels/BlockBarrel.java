...
public class BlockBarrel extends Block {
	...
	public static boolean equals(ItemStack var0, ItemStack var1) {
		return var0 == var1 ? true : (var0 != null && var1 != null ? (!var0.isItemEqual(var1) ? false : (var0.getTagCompound() == var1.getTagCompound() ? true
				: (var0.getTagCompound() != null && var1.getTagCompound() != null ? Arrays.equals(var0.getTagCompound().getTags().toArray(), var1
						.getTagCompound().getTags().toArray()) : false))) : false);
	}
	...
	public boolean onBlockActivated(World var1, int var2, int var3, int var4, EntityPlayer var5, int var6, float var7, float var8, float var9) {
		...
		ItemStack var11 = var5.inventory.mainInventory[var5.inventory.currentItem] == null ? null : var5.inventory.mainInventory[var5.inventory.currentItem]
				.copy();
		...
		if (var10 != null) {
			if (var10.isTimerActive()) {
				...
				if (var11.itemID == Barrels.instance.barrel.blockID
						&& (var10.getItem() != null && var10.getItem().getItemDamage() > var10.getBlockMetadata() || var11 != null
								&& var11.getItemDamage() > var10.getBlockMetadata())) {
