...
public class TileEntityBarrel extends TileEntity implements ISidedInventory
{
    ...
    public int getStackLimit()
    {
        ...
        return var1 == 0 ? Barrels.instance.T1BarrelMaxStorage : (var1 == 1 ? Barrels.instance.T2BarrelMaxStorage : (var1 == 2 ? Barrels.instance.T3BarrelMaxStorage : 0));
    }
    ...
    public void onInventoryChanged()
    {
        if (this.worldObj.isRemote)
        {
            ...
            {
                this.overlay = var1 == 1 ? Integer.toString(this.getItem().getMaxStackSize()) : Integer.toString(var1) + " x " + Integer.toString(this.getItem().getMaxStackSize());
            }
    ...
    {
        return var1 == ForgeDirection.UP ? this.getMode(0) : (var1 == ForgeDirection.DOWN ? this.getMode(1) : (var1 == ForgeDirection.NORTH ? (this.getSide() == 0 ? this.getMode(2) : (this.getSide() == 1 ? this.getMode(4) : (this.getSide() == 2 ? this.getMode(3) : this.getMode(5)))) : (var1 == ForgeDirection.SOUTH ? (this.getSide() == 0 ? this.getMode(3) : (this.getSide() == 1 ? this.getMode(5) : (this.getSide() == 2 ? this.getMode(2) : this.getMode(4)))) : (var1 == ForgeDirection.EAST ? (this.getSide() == 0 ? this.getMode(5) : (this.getSide() == 1 ? this.getMode(2) : (this.getSide() == 2 ? this.getMode(4) : this.getMode(3)))) : (var1 == ForgeDirection.WEST ? (this.getSide() == 0 ? this.getMode(4) : (this.getSide() == 1 ? this.getMode(3) : (this.getSide() == 2 ? this.getMode(5) : this.getMode(2)))) : 0)))));
    }
