...
public class BarrelRender extends TileEntitySpecialRenderer {
	...
	private void renderText(String var1, int var2, double var3, double var5, double var7) {
		...
		GL11.glRotatef(-90 * var2, 0.0F, 1.0F, 0.0F);
	...
	public void renderItem(ItemStack var1, RenderEngine var2, int var3, double var4, double var6, double var8) {
		...
		GL11.glRotatef(-90 * var3, 0.0F, 1.0F, 0.0F);
		...
		GL11.glRotatef(180.0F, 0.0F, 0.0F, 1.0F);
		IItemRenderer var10 = MinecraftForgeClient.getItemRenderer(var1, ItemRenderType.INVENTORY);
		...
		for (var12 = 0; var12 < (var11.requiresMultipleRenderPasses() ? var11.getRenderPasses(var1.getItemDamage()) : 1); ++var12) {
			...
			var14 = (var13 >> 16 & 255) / 255.0F;
			float var15 = (var13 >> 8 & 255) / 255.0F;
			float var16 = (var13 & 255) / 255.0F;
			...
			if ((!(var11 instanceof ItemBlock) || !RenderBlocks.renderItemIn3d(Block.blocksList[var11.itemID].getRenderType())) && var10 == null) {
				...
				this.tessellator.addVertexWithUV(0.0D, 16.0D, 0.0D, var13 % 16 * 16 * 0.00390625D, (var13 / 16 * 16 + 16) * 0.00390625D);
				this.tessellator.addVertexWithUV(16.0D, 16.0D, 0.0D, (var13 % 16 * 16 + 16) * 0.00390625D, (var13 / 16 * 16 + 16) * 0.00390625D);
				this.tessellator.addVertexWithUV(16.0D, 0.0D, 0.0D, (var13 % 16 * 16 + 16) * 0.00390625D, var13 / 16 * 16 * 0.00390625D);
				this.tessellator.addVertexWithUV(0.0D, 0.0D, 0.0D, var13 % 16 * 16 * 0.00390625D, var13 / 16 * 16 * 0.00390625D);
				...
				if (var10 != null) {
					var10.renderItem(ItemRenderType.INVENTORY, var1, new Object[] { this.blockRender });
				} else {
		...
		if (var1.hasEffect()) {
			...
			for (var12 = 0; var12 < 2; ++var12) {
				float var17 = (float) (Minecraft.getSystemTime() % (3000 + var12 * 1873)) / (float) (3000 + var12 * 1873) * 256.0F;
				var14 = var12 == 1 ? -1.0F : 4.0F;
				this.tessellator.addVertexWithUV(0.0D, 16.0D, 0.0D, (var17 + 20.0F * var14) * 0.00390625D, 0.0D);
				this.tessellator.addVertexWithUV(16.0D, 16.0D, 0.0D, (var17 + 20.0F + 20.0F * var14) * 0.00390625D, 0.0D);
				this.tessellator.addVertexWithUV(16.0D, 0.0D, 0.0D, (var17 + 20.0F) * 0.00390625D, 0.0D);
				this.tessellator.addVertexWithUV(0.0D, 0.0D, 0.0D, var17 * 0.00390625D, 0.0D);
			}
	...
	private void renderQuad(int var1, int var2, int var3, int var4, int var5) {
		...
		this.tessellator.addVertex(var1, var2, 0.0D);
		this.tessellator.addVertex(var1, var2 + var4, 0.0D);
		this.tessellator.addVertex(var1 + var3, var2 + var4, 0.0D);
		this.tessellator.addVertex(var1 + var3, var2, 0.0D);
	}
	...
	private void setLight(TileEntity var1, int var2) {
		...
		OpenGlHelper.setLightmapTextureCoords(OpenGlHelper.lightmapTexUnit,
				var1.worldObj.getSavedLightValue(EnumSkyBlock.Block, var1.xCoord + var4, var1.yCoord, var1.zCoord + var3) * 16,
				var1.worldObj.getSavedLightValue(EnumSkyBlock.Sky, var1.xCoord + var4, var1.yCoord, var1.zCoord + var3) * 16);
	}
