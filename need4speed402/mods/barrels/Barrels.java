...
{
    @Mod$Instance("barrels")
    public static Barrels instance;
    @SidedProxy(
            serverSide = "need4speed402.mods.barrels.proxy.Proxy",
            clientSide = "need4speed402.mods.barrels.proxy.ProxyClient"
    )
    ...
    public void preLoad(FMLPreInitializationEvent var1)
    {
        ...
        try
        {
            ...
            this.T1BarrelMaxStorage = var2.get("BarrelStorage", "T1BarrelMaxStorage", this.T1BarrelMaxStorage, "The maximum stacks of items that a barrel can hold.\n Set any value to -1 and that type of barrel will be disabled.").getInt();
            ...
            this.itemScale = (float)var2.get("render", "itemScale", (double)this.itemScale, "Render settings for barrel render.").getDouble((double)this.itemScale);
            this.textScale = (float)var2.get("render", "textScale", (double)this.textScale).getDouble((double)this.textScale);
            this.textX = (float)var2.get("render", "textX", (double)this.textX).getDouble((double)this.textX);
            this.textZ = (float)var2.get("render", "textZ", (double)this.textZ).getDouble((double)this.textZ);
            this.textColor = var2.get("render", "textColor", this.textColor).getInt();
            this.itemX = (float)var2.get("render", "itemX", (double)this.itemX).getDouble((double)this.itemX);
            this.itemZ = (float)var2.get("render", "itemZ", (double)this.itemZ).getDouble((double)this.itemZ);
            this.onlyRenderOneSide = var2.get("render", "onlyRenderOneSide", this.onlyRenderOneSide).getBoolean(this.onlyRenderOneSide);
            this.interaction = var2.get("interaction", "interaction", this.interaction, "How the barrels interact with outside sources (buildcraft pipes)\n Usage: can be in three states: in/out/\'in/out\'\n Formatting: <up>;<down>;<forward>;<back>;<right>;<left>").value;
            this.leaveOneItem = var2.get("interaction", "leaveOneItem", this.leaveOneItem).getBoolean(this.leaveOneItem);
            this.T1barrelCrafting = var2.get("crafting", "T1barrelCrafting", this.T1barrelCrafting, "This allowes you to chage the crafting recipeis.\n Look on the forum for tutorials on setting this up.").value;
