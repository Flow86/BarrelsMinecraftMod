            ...
            if (var8.isRemote)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            var9.getItem().setTagCompound((NBTTagCompound)NBTBase.readNamedTag(new DataInputStream(new ByteArrayInputStream(Arrays.copyOfRange(var4, var10 ? 31 : 30, var4.length)))));
                        }
                    }
